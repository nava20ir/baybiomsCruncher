...
source('module_diann_preprocessing.R')
...
cruncher_ui <- function (id, viewOnly = FALSE)
{
    ...
    dashboardPage(dashboardHeader(title = "MQ Cruncher Test"),
        dashboardSidebar(useShinyjs(), sidebarMenu(id = ns("tabs"),
            ...
            menuItem("DIANN-preprocessing", tabName = ns("loading"),
                icon = icon("file-import"), badgeLabel = "Pending",
                badgeColor = "purple"), menuItem("Normalization",
                tabName = ns("normalization"), icon = icon("compress-alt"),
                badgeLabel = "Pending", badgeColor = "purple"),
            ...
            menuItem("Stats", tabName = ns("stats"), icon = icon("calculator"),
                startExpanded = TRUE, menuItem("t-test", tabName = ns("ttest"),
                  ...
                  badgeColor = "purple"), menuItem("correlation",
            ...
            menuItem("steps up/down", tabName = ns("steps"),
                  ...
                  badgeColor = "purple")), menuItem("Functional Annot",
        ...
        dashboardBody(tabItems(tabItem(tabName = ns("loading"),
            ...
            tabItem(tabName = ns("normalization"), module_normalization_ui(ns("body_normalization"),
                viewOnly = viewOnly)), tabItem(tabName = ns("ttest"),
                module_ttest_ui(ns("stats_ttest"), viewOnly = viewOnly)),

            tabItem(tabName = ns("cortest"), module_cortest_ui(ns("stats_cortest"),
                tabName = ns("cortest"), viewOnly = viewOnly)),

            tabItem(tabName = ns("cortest"), module_cortest_ui(ns("stats_cortest"),
                tabName = ns("cortest"), viewOnly = viewOnly)),

            tabItem(tabName = ns("steps"), module_steps_ui(ns("stats_steps"),
